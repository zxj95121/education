...
class SocketController extends Controller
{
    public function socket()
    {
		...
		require_once '/var/www/html/education/public/php/socket/workerman/Autoloader.php';
		require_once '/var/www/html/education/public/php/socket/mysql-master/src/Connection.php';
		require_once '/var/www/html/education/public/php/socket/mysql-master/vendor/autoload.php';
		...
		$worker->onMessage = function($connection, $data)
		{
		    ...
		    if (isset($user_id)) {/*如果有这个值，说明是传消息的*/
		        $data['content'] = $this->emoji_decode($data['content']);
