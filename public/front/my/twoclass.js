		...
		$.ajax({
			...
			success: function(data){
				if (data.errcode == 0) {
					...
					var str = '<div class="weui-skin_android" id="childsheet" style="opacity: 0;display: none;"> <div class="weui-mask child-weui-mask"></div> <div class="weui-actionsheet"> <div class="weui-actionsheet__menu"> ';
