        ...
        <aside class="left-panel">
            ...
            <nav class="navigation">
                <ul class="list-unstyled">
                    ...
                    <li class="has-submenu {!!(Request::is('admin/managerList','admin/managerReview','admin/parentInfo','admin/teacherInfo','admin/share')? 'active' : '') !!}">
                        <a href="#">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="{!!(Request::is('admin/share')? 'active' : '') !!}">
                                <a href="/admin/share">用户分享</a>
                            </li>
                        </ul>
                    </li>
                    <li class="has-submenu {!!(Request::is('admin/doubleTeacher', 'admin/classPrice', 'admin/setClassTime', 'admin/eclassOrderList', 'admin/classProgress')? 'active' : '') !!}">
                        <a href="#">
                    ...
                    <li class="has-submenu {!!(Request::is('admin/communityManage','admin/subjectManage','admin/schoolManage','admin/hobbyManage','admin/classSetting','admin/festivalSetting')? 'active' : '') !!}">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="{!!(Request::is('admin/festivalSetting')? 'active' : '') !!}">
                                <a href="/admin/festivalSetting">节假日设置   </a>
                            </li>
                        </ul>
                    </li>
