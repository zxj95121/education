	        		...
	        		<div class="col-md-3 col-xs-12 col-sm-12" style="padding-left: 10px;padding-right: 10px;">
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-12" style="padding-top: 20px;">
                            <div class="widget-panel widget-style-1 bg-info">
                            	<span style="display: inline-block;background: #65ad3a;z-index:333;position:absolute;padding: 0 0 0.7rem 0.8rem;right: 0px;top: 0px;font-size:1rem;color: #fff;border-bottom-left-radius: 100% 100%;">新订单</span>
