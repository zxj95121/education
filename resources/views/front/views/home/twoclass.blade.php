...
<div id="twoclass">
	<div class="weui-cell weui-cell_access twoclassHead" style="height:40px;background:#22AAE8;color:#FFF;padding: 0px 15px;">
	    @if($class != 'class1')
	     	<div style="height: 80%;position: absolute;top: 10%;"><div class="glyphicon glyphicon-menu-left btn-lg" id="houtui" fenlei="{{$class}}" style="padding-top: 3px; padding-left: 0px;"> <span style="font-size: 18px;position: relative;top: -2px;left: -12px;">返回</span></div></div>
	    @endif
	...
	@else
        ...
        @endforeach	
        	...
        	<div id="zhicheng"></div>
        	<div id="myCart" style="height: 40px;background: #1F9B12/*52525A*/;width: 100%;z-index: 999;">
                ...
                <div style="width:30%;height: 100%;text-align: center;background: #0A4DDB;z-index: 999;line-height: 40px;float: right;color:#FFF;font-size:18px;cursor:pointer;" id="myCartRight">
                	生成订单
                </div>
            </div>
            ...
            <form id="cartOrderForm" action="/front/parent/newEclassOrder" method="post" style="display: none;">
            	...
            	<input type="hidden" name="cartTotal" id="inputcartTotal">
            	{{csrf_field()}}
            </form>
