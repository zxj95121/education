...
<div id="twoclass">
	<div class="weui-cell weui-cell_access twoclassHead" style="height:40px;background:#22AAE8;color:#FFF;padding: 0px 15px;">
	    @if($class != 'class1')
	     	<div style="height: 80%;position: absolute;top: 10%;"><div class="glyphicon glyphicon-menu-left" id="houtui" fenlei="{{$class}}" style="line-height: 32px;"><span>返回</span></div></div>
	    @endif
