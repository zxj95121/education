				...
				<div class="content-block" style='margin: 4px 0px 0.38rem;color: #557ECB;font-size: 0.9em;' onclick="window.location.href='https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzIxNzg4MDY4Ng==&scene=124#wechat_redirect';">加辰教育定制</div>
			  	...
			  	<div class="content-block">
    				<p class="buttons-row">
    					...
    					<a href="#" class="button button-big button-fill button-success active" style="border-radius: 5px;width: 60%;margin: 0 auto;color: #FFF;border-color: #D34827;" onclick="window.location.href='/front/classPackage/newOrder/oauth?cid={{$package->id}}';">购买课程</a>
