	...
	<div class="page">
	  	...
	  	<div class="content">
		  	<div class="buttons-tab">
			    ...
			    @if(count($userObj) > 0 && $userObj[0]->type == 1)
					      		...
					      		<li class="urlPay urlPay0" vid="{{$value['id']}}">
						        	<a href="javascript:void(0);" class="item-link item-content" style="font-size: 15px;">
						          		<div class="item-inner">
						            		...
						            		<div class="item-text">
						            			券优惠：<span style="font-size: 15px;color: #343639;">{{$value['voucher_num']*88}}元</span>
						            		</div>
					      		...
					      		<li class="urlPay" vid="{{$value['id']}}">
						        	<a href="javascript:void(0);" class="item-link item-content" style="font-size: 15px;">
						          		<div class="item-inner">
						            		...
						            		<div class="item-subtitle">英语主题party：<span style="color:#2e7900;">{{$value['paty']}}次</span></div>
						          		</div>
						        	</a>
					      		</li>
					    	</ul>
