			...
			<div class="content" style="background: #D6D6D6;">
			    ...
			    <div id="chatview" class="p1" style="width:100%;height:100%;position: relative;">
			        ...
			        <div id="sendmessage">
			        	...
			        	<textarea id="textInput" style="height: 38px;margin-top: 6px;padding-left: 0.3em;px;color: #000;line-height: 19px;resize: none;border: 0px solid transparent;font-size: 19px;">fda</textarea>
