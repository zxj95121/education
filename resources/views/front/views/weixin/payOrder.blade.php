...
<body>
	<div class="page">
	  	<header class="bar bar-nav">
	    	<a class="button button-link button-nav pull-left" style="cursor: pointer;" onclick="window.location.href='/front/share';" data-transition='slide-out'>
				...
				<ul>
  					...
  					<li class="item-content">
    					...
    					<div class="item-inner">
      						...
      						<div class="item-after">{{$orderObj->record_num}} 次课</div>
    					</div>
  					</li>
  					<li class="item-content">
    					<div class="item-media"><i class="icon icon-f7"></i></div>
    					<div class="item-inner">
      						...
      						<div class="item-after">¥ {{number_format((string)$orderObj->price, 2)}}</div>
    					</div>
  					</li>
  					<li class="item-content">
    					<div class="item-media"><i class="icon icon-f7"></i></div>
