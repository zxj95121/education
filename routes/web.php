...
/*管理后台组*/
Route::group(['prefix' => 'admin','namespace' => 'Admin','middleware' => ['web','admin','domainAdmin']], function ($router) {
...
Route::group(['prefix' => 'front','namespace' => 'Front','middleware' => ['web','wechat','domainFront']], function ($router) {
    /*用户身份绑定*/
...
/*微信用户展示（需要系统身份的路由放这里）*/
Route::group(['prefix' => 'front','namespace' => 'Front','middleware'=>['web','front','domainFront']], function ($router) {
});
